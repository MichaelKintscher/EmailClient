...
namespace WindowsOS.Network
{
    /// <summary>
    /// Contains methods for parsing MIME messages.
    /// </summary>
    public static class MimeParser
    {
        public static async Task<Email> ParseMimeAsync(string content)
        {
            MemoryStream stream = new MemoryStream(Convert.FromBase64String(content), false);
