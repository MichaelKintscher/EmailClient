...
{
    /// <summary>
    /// Contains methods for manipulating EmailProviderAccount models.
    /// </summary>
    internal class EmailProviderAccountManager
    {
        /// <summary>
        ...
        public static EmailProviderAccount Deserialize(JsonObject accountJson)
        {
            string id = accountJson["id"].GetString();
            EmailProvider provider = Enum.Parse<EmailProvider>(accountJson["provider"].GetString());
        ...
        public static JsonObject Serialize(EmailProviderAccount account)
        {
